...
namespace MatrixFree {
  ...
  class IPDGBlockJacobi : public LocalOperator<V, GV> {
    ...
    public:
      ...
      template<class LS>
      IPDGBlockJacobi(const Basis& b, LS&& localSolver, double penalty=2.0, bool dirichlet=false) :
        basis_(b),
        penalty_(penalty),
      ...
      void compute() {
        ...
        localSolver_(localMatrix_, insideCoeffs, localVector_);
      }
