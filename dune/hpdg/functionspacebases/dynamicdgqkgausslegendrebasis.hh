...
#ifndef DUNE_FUNCTIONS_FUNCTIONSPACEBASES_DYNAMIC_DG_QK_GaussLegendre_BASIS_HH
#define DUNE_FUNCTIONS_FUNCTIONSPACEBASES_DYNAMIC_DG_QK_GaussLegendre_BASIS_HH
...
//
//   DynamicDGQkGaussLegendreNodeFactory
//   DynamicDGQkGaussLegendreNodeIndexSet
//   DynamicQkGaussLegendreNode
//
...
template<typename GV, class MI>
class DynamicDGQkGaussLegendreNodeFactory
{
...
public:
  ...
  DynamicDGQkGaussLegendreNodeFactory(const GridView& gv, int k = 1) :
    gridView_(gv),
